            ...
            <div className="post-card bg-white shadow-sm rounded flex flex-col">
                ...
                <div className="post-card-content p-2 flex flex-col flex-1 justify-between">
                    ...
                    <div className="post-card-meta">
                        <p className="text-gray-500">{meta.length > 80 ? meta.substring(0, 75) + "..." : meta}</p>
                    </div>
                    ...
                    <MobileView title={title} content={content} thumbnail={thumbnail.url} visible={displayMobileView} onClose={() => setDisplayMobileView(false)} />
